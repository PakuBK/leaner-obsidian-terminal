...
const BASH_SCRIPT = `
# Lean Obsidian Terminal — shell integration for bash
...
const ZSH_SCRIPT = `
# Lean Obsidian Terminal — shell integration for zsh
...
const PWSH_SCRIPT = `
# Lean Obsidian Terminal — shell integration for PowerShell
